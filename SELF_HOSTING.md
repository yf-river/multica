...
Open http://localhost:3000 and log in with the account and password provisioned for the instance. See [Step 2 — Log In](#step-2--log-in) for details.
...
Open http://localhost:3000 in your browser and enter the account and password provisioned by your operator. Local development environments print their generated account details after startup.
...
Leave optional values empty for now — you can fill them in later.
...
Open the frontend and enter the account and password provisioned by your operator. Authentication does not depend on an email delivery service.
