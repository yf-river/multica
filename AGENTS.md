...
- **Zustand** owns client/view state (view filters, drafts, modals, tab layout); current workspace identity is route-driven and only mirrored for platform plumbing
