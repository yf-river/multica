...
import zhHansLife from "./zh-Hans/life.json";
...
// Single source of truth for the resource bundle. Shared clients import from
// here so adding a locale or namespace happens in exactly one place.
