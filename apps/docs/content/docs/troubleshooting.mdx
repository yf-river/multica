...
When `SMTP_HOST` and Resend are both configured, Multica prefers SMTP for invitation and notification email. For configuration, see [Sign-in and signup](/auth-setup).
