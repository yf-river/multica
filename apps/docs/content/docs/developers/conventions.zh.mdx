...
本页是代码命名规范、i18n 翻译术语表、中文风格指南的唯一权威来源。
...
- ❌ `/new-workspace`、`/create-team`、`/legacy-join`
...
| `packages/views` | `core/`、`ui/` | `next/*`、stores |
| `apps/web/platform/` | `next/*` | 其他 app |

复用的逻辑，**必须**抽到共享包。"小段重复"也不算例外。
