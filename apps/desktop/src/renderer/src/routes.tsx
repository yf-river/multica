        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { path: "runs", element: <PromptLibraryPage />, handle: { title: "训练与评估" } },
              { path: "prompts", element: <PromptLibraryPage />, handle: { title: "训练与评估" } },
              { path: "prompt-playground", element: <PromptLibraryPage />, handle: { title: "训练与评估" } },
              { path: "agent-playground", element: <PromptLibraryPage />, handle: { title: "训练与评估" } },
              { path: "datasets", element: <PromptLibraryPage />, handle: { title: "训练与评估" } },
              { path: "test-suites", element: <PromptLibraryPage />, handle: { title: "训练与评估" } },
              { path: "experiments", element: <PromptLibraryPage />, handle: { title: "训练与评估" } },
              { path: "optimization-runs", element: <PromptLibraryPage />, handle: { title: "训练与评估" } },
              { path: "run-history", element: <PromptLibraryPage />, handle: { title: "训练与评估" } },
            ],
          },
          {
            path: "prompt-library",
