...
const DEFAULT_E2E_ACCOUNT = process.env.E2E_ACCOUNT ?? "develop";
const DEFAULT_E2E_PASSWORD = process.env.E2E_PASSWORD ?? "develop123";
 ...
 * Authenticates via the account/password API, then injects
