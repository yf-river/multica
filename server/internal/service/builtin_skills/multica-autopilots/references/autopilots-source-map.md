...
- `server/internal/service/autopilot_projection.go` projects terminal Issue/Task events into `autopilot_run`; `server/cmd/server/autopilot_projection.go` registers the replay-safe outbox consumer.
