...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"companion_profile":                  workspaceDelete,
	...
	"domain_event_delivery":              workspaceDelete,
	"domain_event_outbox":                workspaceDelete,
	"external_credential_profile":        workspaceDeleteKeep,
	...
	"life_action_proposal":               workspaceDelete,
	"life_chronicle_cursor":              workspaceDelete,
	"life_chronicle_entry":               workspaceDelete,
	"life_chronicle_evidence":            workspaceDelete,
	"life_chronicle_revision":            workspaceDelete,
	"life_cognition_job":                 workspaceDelete,
	"life_commitment":                    workspaceDelete,
	"life_context_state":                 workspaceDelete,
	"life_derivation":                    workspaceDelete,
	"life_experiment":                    workspaceDelete,
	"life_experiment_memory":             workspaceDelete,
	"life_experiment_observation":        workspaceDelete,
	"life_experiment_round":              workspaceDelete,
	"life_forget_tombstone":              workspaceDelete,
	"life_identity_version":              workspaceDelete,
	"life_internal_thought":              workspaceDelete,
	"life_material":                      workspaceDelete,
	"life_memory":                        workspaceDelete,
	"life_memory_dependency":             workspaceDelete,
	"life_memory_evidence":               workspaceDelete,
	"life_memory_revision":               workspaceDelete,
	"life_module":                        workspaceDelete,
	"life_module_version":                workspaceDelete,
	"life_observation_topic":             workspaceDelete,
	"life_observation_topic_judgement":   workspaceDelete,
	"life_observer":                      workspaceDelete,
	"life_observer_judgement":            workspaceDelete,
	"life_observer_knowledge":            workspaceDelete,
	"life_observer_version":              workspaceDelete,
	"life_proactive_check":               workspaceDelete,
	"life_proactive_policy":              workspaceDelete,
	"life_relationship_event":            workspaceDelete,
	"life_topic":                         workspaceDelete,
	"life_topic_memory":                  workspaceDelete,
	"life_upgrade_evaluation":            workspaceDelete,
	...
	"task_trace_event":                   workspaceDelete,
