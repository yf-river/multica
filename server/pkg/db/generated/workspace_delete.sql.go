...
const deleteWorkspaceDomainEvents = `-- name: DeleteWorkspaceDomainEvents :exec
...
func (q *Queries) DeleteWorkspaceDomainEvents(ctx context.Context, workspaceID pgtype.UUID) error {
	_, err := q.db.Exec(ctx, deleteWorkspaceDomainEvents, workspaceID)
	return err
}
...
const deleteWorkspaceLifeContextState = `-- name: DeleteWorkspaceLifeContextState :exec
...
func (q *Queries) DeleteWorkspaceLifeContextState(ctx context.Context, workspaceID pgtype.UUID) error {
	_, err := q.db.Exec(ctx, deleteWorkspaceLifeContextState, workspaceID)
	return err
}

const deleteWorkspaceLifeData = `-- name: DeleteWorkspaceLifeData :exec
WITH
...
func (q *Queries) DeleteWorkspaceLifeData(ctx context.Context, workspaceID pgtype.UUID) error {
	_, err := q.db.Exec(ctx, deleteWorkspaceLifeData, workspaceID)
	return err
}
