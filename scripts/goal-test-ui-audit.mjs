...
const routes = [
  ...
  { id: "training-optimization-runs", label: "训练与评估/优化运行", path: `/${workspaceSlug}/training/optimization-runs`, expect: ["优化运行"] },
  { id: "training-run-history", label: "训练与评估/运行历史", path: `/${workspaceSlug}/training/run-history`, expect: ["运行历史"] },
];
