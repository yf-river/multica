...
const ownerAccount = trimEnv("GOAL_TEST_ONBOARDING_OWNER_ACCOUNT") || trimEnv("ACCEPTANCE_DEMO_ACCOUNT") || "develop";
const ownerPassword = trimEnv("GOAL_TEST_ONBOARDING_OWNER_PASSWORD") || trimEnv("ACCEPTANCE_DEMO_PASSWORD") || "develop123";
const workspaceSlug = trimEnv("GOAL_TEST_ONBOARDING_WORKSPACE_SLUG") || trimEnv("ACCEPTANCE_WORKSPACE_SLUG") || "ai-studio";
